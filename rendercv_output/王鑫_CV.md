...
# 学术发表
## **大规模稀疏混合专家模型：面向万亿参数模型的高效路由**

7月 2023

*王鑫*, Sarah Williams, David Park
...
[10.1234/neurips.2022.5678](https://doi.org/10.1234/neurips.2022.5678) (NeurIPS 2022, 亮点报告)
...
[10.1234/iclr.2021.3456](https://doi.org/10.1234/iclr.2021.3456) (ICLR 2021, 最佳论文奖)
...
# 专业技能
**编程语言:** Python, C++, CUDA, Rust, Julia

**机器学习框架:** PyTorch, JAX, TensorFlow, Triton, ONNX

**基础设施:** Kubernetes, Ray, 分布式训练, AWS, GCP

**研究方向:** 神经架构搜索、模型压缩、高效推理、多智能体强化学习

# 专利
1. 神经网络端侧推理的自适应量化方法（美国专利 11,234,567）

1. 高效 Transformer 注意力的动态稀疏模式（美国专利 11,345,678）

1. 硬件感知的神经架构搜索方法（美国专利 11,456,789）

# 受邀报告
1. 高效推理的缩放定律 — 斯坦福 HAI 研讨会（2024）

1. 构建下一代 AI 基础设施 — TechCrunch Disrupt（2024）

1. 从研究到生产：机器学习系统的经验教训 — NeurIPS 研讨会（2023）

1. 高效深度学习：实践者的视角 — Google 技术讲座（2022）
